...
export class QueryService {
 ...
 fetchRewardList = `SELECT ${TableRewardsEntity.id},${TableRewardsEntity.rewardName}, ${TableRewardsEntity.rewardIcon} FROM ${Tables.Table_Rewards}  UNION all SELECT ${TableRewardsEntity.id},${TableCustomRewardsEntity.rewardName}, ${TableCustomRewardsEntity.rewardIcon} AS reward_icon  FROM ${Tables.Table_CustomRewards} WHERE ${TableCustomRewardsEntity.userId} = ?`
